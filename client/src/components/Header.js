...
import { faShoppingCart, faDollarSign, faEuroSign } from '@fortawesome/free-solid-svg-icons';
        ...
        return (
            <>
                ...
                <div className="row" style={styles.top}>
                    ...
                    {props.showCart && <div className="col-4 align-text-bottom" style={styles.cart}>
                        <select onChange={props.pickCurrency} value={props.currency} style={styles.switcher}>
                            <option value="eur">€</option>
                            <option value="gbp">£</option>
                        </select>
                        <Link to="/checkout" style={{ textDecoration: 'none', color: 'inherit' }}>
                            <FontAwesomeIcon icon={faShoppingCart} /> {props.cart?.lineItems.length ? props.cart.lineItems.length : 0}
                        </Link>
                    </div>}
                </div>
            </>
